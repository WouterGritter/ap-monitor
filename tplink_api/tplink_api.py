...
from tplink_api.classes import (
    PoeClass,
    PoePowerLimit,
    PoePowerStatus,
    PoePriority,
...
from tplink_api.coreapi import TpLinkWebApi, VariableType
from tplink_api.tplink_utils import TpLinkFeaturesDetector
